...
{
    // [JobProducerType(typeof(IMoveSystemStaticSystemJobExtensions.QuerySystemJobWrapper<>))]
    // public interface IMoveSystemStaticSystemJob {
    //     void OnUpdate(ref Query<Transform, Input>.WithEntity query);
    // }
    // // ReSharper disable once InconsistentNaming
    // public static class IMoveSystemStaticSystemJobExtensions {
    //     [StructLayout(LayoutKind.Sequential)]
    //     internal unsafe struct QuerySystemJobWrapper<TJob> where TJob : struct, IMoveSystemStaticSystemJob {
    //         public TJob JobData;
    //         public SystemMode mode;
    //         [NativeDisableUnsafePtrRestriction] public Query<Transform, Input>.WithEntity* query;
    //         public State State;
    ...
    //                         fullData.JobData.OnUpdate(ref copy);
    //                     }
    //                     break;
    ...
    //                     fullData.JobData.OnUpdate(ref *fullData.query);
    //                     break;
    //             }
    //         }
    //     }
    //
    //
    //     public static void EarlyJobInit<T>() where T : struct, IMoveSystemStaticSystemJob {
    //         QuerySystemJobWrapper<T>.Initialize();
    //     }
    //
    //     private static IntPtr GetReflectionData<T>() where T : struct, IMoveSystemStaticSystemJob {
    //         QuerySystemJobWrapper<T>.Initialize();
    ...
    //         where TJob : struct, IMoveSystemStaticSystemJob {
    ...
    // // Generated 
    // // ReSharper disable once InconsistentNaming
    // public class IMoveSystemStaticQuerySystemJobRunner<TJob> : ISystemRunner where TJob : struct, IMoveSystemStaticSystemJob
    // {
    //     public TJob System;
    ...
    // // Generated
    // // ReSharper disable once InconsistentNaming
    // public static class MoveSystemStatic_Generated
    // {
    //     [BurstCompile]
    //     public struct MoveSystemStaticJob : IMoveSystemStaticSystemJob 
    //     {
    //         public void OnUpdate(ref Query<Transform, Input>.WithEntity query)
    //         {
    //             foreach (var (e, t, i) in query)
    //             {
    //                 t.Val.Position.x += i.Val.h;
    //                 t.Val.Position.z += i.Val.v;
    //             }
    //         }
    //     }
    //     public delegate void SystemActionQueryTransformInputWithEntity(ref Query<Transform, Input>.WithEntity query);
    //
    //     public static Systems Add(this Systems systems, SystemActionQueryTransformInputWithEntity systen,
    //         SystemMode threads = SystemMode.Parallel)
    //     {
    //         var runner = new IMoveSystemStaticQuerySystemJobRunner<MoveSystemStaticJob>
    //         {
    //             System = new MoveSystemStaticJob(),
    //             Mode = threads,
    //             EcbJob = default,

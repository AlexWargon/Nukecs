namespace Wargon.Nukecs.Collision2D {
    ...
    public struct Collision2DHitsParallelJob : IJobParallelFor {
        ...
        public void Execute(int idx) {
            ...
            for (var dy = -1; dy <= 1; ++dy) {
                ...
                for (var i = 0; i < cell1.CollidersBuffer.Count; i++) {
                    ...
                    // Круг vs Круг (существующая логика)
                    ...
                    // Круг vs Прямоугольник (существующая логика с обновленным методом)
                ...
                // Прямоугольник vs Прямоугольник (новая логика)
        ...
        {
            // Получаем позицию левого нижнего угла прямоугольника
            ...
            {
                distance = 0.0f; // Круг внутри прямоугольника
            }
            else
            {
            ...
            // Вычисляем пересечение и нормаль
            ...
            else if (overlap > 0) // Круг внутри прямоугольника
            {
                // Определяем ближайшую сторону для выталкивания
            ...
            // Применяем коррекцию позиции, если не триггер

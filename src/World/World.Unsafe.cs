    ...
    public unsafe partial struct World
    {
        ...
        public partial struct WorldUnsafe {
            internal void OnDeserialize(ref MemAllocator allocator)
            {
                ...
                entityDirtyVersion.OnDeserialize(ref allocator);
            ...
            public byte Id;
            public AliveEntitiesSet entitiesDens;
            public MemoryList<Entity> entities;
            public MemoryList<Entity> prefabsToSpawn;
            public MemoryList<int> reservedEntities;
            internal Archetype rootArchetype;
            public MemoryList<int> entitiesArchetypes;
            public MemoryList<ushort> entityGenerations;
            public MemoryList<uint> entityDirtyVersion;
            public HashMap<int, Archetype> archetypesMap;
            public MemoryList<ptr<ArchetypeUnsafe>> archetypesList;
            public MemoryList<GenericPool> pools;
            public int poolsCount;
            public MemoryList<ptr<QueryUnsafe>> queries;
            public HashMap<int, int> queriesHashToIndex;
            public EntityCommandBuffer EntityCommandBuffer;
            public EntityCommandBuffer FixedUpdateECB;
            public JobHandle systemsUpdateJobDependencies;
            public JobHandle systemsFixedUpdateJobDependencies;
            public int job_worker_count;
            public MemoryList<int> DefaultNoneTypes;
            public int entitiesAmount;
            public int lastEntityIndex;
            public int lastDestroyedEntity;
            ...
            private void Initialize(byte id, WorldConfig worldConfig, ptr<WorldUnsafe> worldSelf, ref UnityAllocatorHandler allocatorHandler) {
                ...
                entityDirtyVersion = new MemoryList<uint>(worldConfig.StartEntitiesAmount, ref AllocatorRef, clear:true);
                ...
                FixedUpdateECB = new EntityCommandBuffer(256, Allocator.Persistent);
                spinner = new Spinner();
            ...
            public Entity CreateEntity() {
                ...
                try {
                    if (lastEntityIndex >= entities.Capacity) {
                        ...
                        entityDirtyVersion.Resize(newCapacity, ref AllocatorRef);

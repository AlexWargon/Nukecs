...
{
    [TestFixture]
    public unsafe class RuntimeQueryProductionRegressionTests
    {
        [Test]
        ...
        public void DefaultPools_LazyPages_AndPageTableGrowth_RemainSupported()
        {
            ...
            try
            {
                ...
                AssertSameRows(query.iter(), query.iter_paged_pool_runtime());
            }
            finally { world.Dispose(); }
        }
        ...
        private static void Check<T1, T2, T3, T4>(
            QueryRuntimeIter4<QueryRuntimeRefs<T1, T2, T3, T4>> iterator, Entity[] entities,
            ...
            where T3 : unmanaged, IComponent where T4 : unmanaged, IComponent
        {
            ...
            var saved = default(QueryRuntimeRefs<T1, T2, T3, T4>);
            var savedId = -1;
        ...
        private static void AssertSameRows<T1, T2, T3, T4>(
            QueryRuntimeIter4<QueryRuntimeRefs<T1, T2, T3, T4>> expected,
        ...
        public void AllPools_StorageWithoutInlineColumns_EmptyAndAppendSnapshot()
        {
            ...
            try
            {
                ...
                query.Update(ref world, IntPtr.Zero);
                var sum = 0;
                foreach (var (a, _, _, _) in query.iter()) sum += a.Read.Id;
